angular.module('angular-img-cropper', []).directive("imageCropper", [
    '$document', '$window', 'imageCropperDataShare', "$q","$timeout",
    function ($document, $window, imageCropperDataShare, $q, $timeout) {
        return {
            scope: {
                image: "=",
                croppedImage: "=",
            ...
            link: function (scope, element, attrs) {
                ...
                var ImageCropper = (function () {
                    function ImageCropper(canvas, x, y, width, height, keepAspect, touchRadius) {
                        ...
                        function onTouchMove(e) {
                            that.onTouchMove.call(that, e);
                        }
                        function onTouchEnd(e) {
                            that.onTouchEnd.call(that, e);
                        }
                        function onMouseDown(e) {
                            that.onMouseDown.call(that, e);
                        }
                        function onTouchStart(e) {
                            that.onTouchStart.call(that, e);
                        }
                ...
                var initElementPromise = $q.defer();
                    ...
                    function (newValue) {
                        if (newValue != null) {
                            ...
                            imageObj.addEventListener("load", function () {
                                initElementPromise.promise.then(function () {
                ...
                scope.$on("$destroy", function () {
                    if (crop)
                        crop.destroy();
                    console.log("cropper was destroyed")
                });
            }
        };
    }]);
